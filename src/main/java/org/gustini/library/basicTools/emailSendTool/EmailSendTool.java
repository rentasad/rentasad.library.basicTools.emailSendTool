...
public class EmailSendTool
{
    ...
    public EmailSendTool(
                         EmailConfigObject emailConfigObject)
    {
        super();
     ...
     *             Creation: 23.10.2015 by mst
     */
    public String sendMailWithAttachment(final String toMultiple, final String bcc, final String from, final String subject, final String messageText, final EmailAttachment attachment) throws EmailException
    {
     ...
     *             Creation: 22.10.2015 by mst
     */
    public String sendMail(String toMultiple, String from, String subject, String messageText) throws FileNotFoundException, EmailException
    {
